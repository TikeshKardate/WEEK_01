...
public class NumberChecker1 {
    ...
    public static int[] storeDigits(int num) {
        ...
        // => same as convert other data values convert into string object
        String numStr = String.valueOf(num);  
        int[] digits = new int[numStr.length()];
        for (int i = 0; i < numStr.length(); i++) {

            //=> '0' is convert into string 
    ...
    public static boolean isArmstrongNumber(int num, int[] digits) {
        ...
        //  153 = 1^3 + 5^3 + 3^3   basically power is length 
    ...
    public static int[] findLargestTwo(int[] digits) {
        ...
        for (int digit : digits) {
            if (digit > largest) {
                ...
                // means previous large value is become secondlargest and 
                secondLargest = largest; 

                // now this large value which is assign to largest
                largest = digit;          
        ...
        // return this largest value array of size two.
